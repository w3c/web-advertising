...
| [Ad Quality](#ad-quality) | Very limited support as opaque iframe aggregated reporting allow for very little ex post audit. | No Support | SPARROW: The Gatekeeper enforces the policy defined by the publisher. <br> The aggregated report and Delayed served ads report can be leveraged for ex post ad quality audit. |
