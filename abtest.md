...
// if past sell-by date delete it and do not show ad
    ...
    <div class="abc1" ad=“domain=audiencemeasurement.com;id=30045;triggertype=viewable;triggerKey=abc1;margin=5px;threshold=0.8;after=5000“>
        ... render ad 1
    </div>
    <div class="abc2" ad=“domain=audiencemeasurement.com;id=30045;triggertype=viewable;triggerKey=abc2;margin=5px;threshold=0.8;after=5000“>
        ... render ad 2
    </div>
    <div class="abc3"  ad=“domain=audiencemeasurement.com;id=30045;triggertype=viewable;triggerKey=abc3;margin=5px;threshold=0.8;after=5000“>
        ... render ad 3
    </div>
```